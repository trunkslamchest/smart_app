...
export const voteStarsRatingIndex = {
  ...
  "FiveStars": five_star_rating,
  "FourStars": four_star_rating,
  "ThreeStars": three_star_rating,
  "TwoStars": two_star_rating,
  "OneStars": one_star_rating,
  "ZeroStars": zero_star_rating,
  "FiveStarsGrey": five_star_rating_grey,
  "FourStarsGrey": four_star_rating_grey,
  "ThreeStarsGrey": three_star_rating_grey,
  "TwoStarsGrey": two_star_rating_grey,
  "OneStarsGrey": one_star_rating_grey,
  "ZeroStarsGrey": zero_star_rating_grey
}

export const voteStarsDashboardRatingIndex = {
  "FiveStars": five_star_dashboard_rating,
  "FourStars": four_star_dashboard_rating,
  "ThreeStars": three_star_dashboard_rating,
  "TwoStars": two_star_dashboard_rating,
  "OneStars": one_star_dashboard_rating,
  "ZeroStars": zero_star_dashboard_rating,
}