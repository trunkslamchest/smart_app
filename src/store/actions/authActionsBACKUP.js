...
export const authStart = (authType, obj) => {
  return dispatch => {
    ...
    if(authType === 'editProfile') {
      ...
      // dispatch(authEditUser(authType, obj))
...
//     authFunctions('refreshToken', auth.update, newObj)
...
//         passwordHash: authRes.passwordHash
//       }))
//     })
//   }
// }
...
const authEditUser = (authType, obj, updateObj) => {
 return dispatch => {
    ...
    .then(updateRes => {
      ...
      // dispatch(authUpdateStatus('updateAuthUserSuccess', true))
  ...
  //           // authFunctions('editUser', auth.editUser, obj)
  //           // authFunctions('editUser', `https://identitytoolkit.googleapis.com/v1/accounts:update?key=${process.env.REACT_APP_FIREBASE_API_KEY}`, obj)
  //           // authFunctions('editUser', 'https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyBSKeC86vFuphU91Ylbrdf9RMDO8SGam5E', authObj)
  //           // .then(authRes => {
  //           //   console.log(authRes)
  //           //   if(!!authRes.error) dispatch(authFail(authRes.error))
  //           //   else dispatch(authSuccess(authType, {
