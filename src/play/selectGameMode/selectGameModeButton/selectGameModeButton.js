...
import './selectGameModeButton.css'

const SelectGameModeButton = (props) => {

  const onClickFunctions = () => {
    props.onSetGameMode(props.value)
  }
  ...
  return(
    <button
      key={ props.key }
      value={ props.value }
      className="select_game_mode_button"
      name={`${ props.value }_button`}
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectGameModeButton)