...
const TermsOfService = (props) => {
  ...
  return(
    <div className='terms_wrapper'>
      ...
      You agree that by accessing SmartApp™, you have read, understood, and agreed to be bound by all of these Terms of Use.
      </p>
      <p>
      Supplemental terms and conditions or documents that may be posted on SmartApp™ from time to time are hereby expressly incorporated herein by reference.
      ...
      the changes in any revised Terms of Use by your continued use of SmartApp™ after the date such revised Terms of Use are posted.
      </p>
      <p>
      The information provided on SmartApp™ is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution
      ...
      Accordingly, those persons who choose to access SmartApp™ from other locations do so on their own initiative and are solely responsible for compliance with local laws,
      if and to the extent local laws are applicable.
      </p>
      <p>
      SmartApp™ is intended for users who are at least 13 years of age.
      ...
      and be directly supervised by, their parent or guardian to use SmartApp™.
      If you are a minor, you must have your parent or guardian read and agree to these Terms of Use prior to you using SmartApp™.
      </p>
      <p>
      IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING SMARTAPP™ AND YOU MUST DISCONTINUE USE IMMEDIATELY.
      </p>

      <h2>INTELLECTUAL PROPERTY RIGHTS</h2>
      <p>
      Unless otherwise indicated, SmartApp™ is our proprietary property and all source code,
      databases, functionality, software, website designs, audio, video, text, photographs, and graphics on SmartApp™
      (collectively, the “Content”) and the trademarks, service marks, and logos contained therein (the “Marks”) are owned or controlled by us or licensed to SmartApp™,
      and are protected by copyright and trademark laws and various other intellectual property rights and unfair competition laws of the United States,
      foreign jurisdictions, and international conventions.
      The Content and the Marks are provided on SmartApp™ “AS IS” for your information and personal use only.
      Except as expressly provided in these Terms of Use, no part of SmartApp™
      and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed,
      ...
      <p>
      Provided that you are eligible to use SmartApp™,
      you are granted a limited license to access and use SmartApp™ and to download or
      ...
      We reserve all rights not expressly granted to you in and to SmartApp™, the Content and the Marks.
      </p>

      <h2>USER REPRESENTATIONS</h2>
      <p>
      By using SmartApp™, you represent and warrant that:
        <ul>
      ...
      we have the right to suspend or terminate your account and refuse any and all current or future use of SmartApp™ (or any portion thereof).
      </p>

      <h2>USER REGISTRATION</h2>
      <p>
      You may be required to register with SmartApp™.
      ...
      <p>
      You may not access or use SmartApp™ for any purpose other than that for which we make SmartApp™ available.
      SmartApp™ may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
      </p>
      <p>
      As a user of SmartApp™, you agree not to:
        <ul>
          <li>1.  Systematically retrieve data or other content from SmartApp™ to create or compile, directly or indirectly, a collection, compilation, database, or directory without written permission from us.</li>
          <li>2.  Make any unauthorized use of SmartApp™, including collecting usernames and/or email addresses of users by electronic or other means for the purpose of sending unsolicited email, or creating user accounts by automated means or under false pretenses.</li>
          <li>3.  Use a buying agent or purchasing agent to make purchases on SmartApp™.</li>
          <li>4.  Use SmartApp™ to advertise or offer to sell goods and services.</li>
          <li>5.  Circumvent, disable, or otherwise interfere with security-related features of SmartApp™, including features that prevent or restrict the use or copying of any Content or enforce limitations on the use of SmartApp™ and/or the Content contained therein.</li>
          <li>6.  Engage in unauthorized framing of or linking to SmartApp™.</li>
          ...
          <li>10.  Interfere with, disrupt, or create an undue burden on SmartApp™ or the networks or services connected to SmartApp™.</li>
          ...
          <li>13.  Use any information obtained from SmartApp™ in order to harass, abuse, or harm another person.</li>
          <li>14.  Use SmartApp™ as part of any effort to compete with us or otherwise use SmartApp™ and/or the Content for any revenue-generating endeavor or commercial enterprise.</li>
          <li>15.  Decipher, decompile, disassemble, or reverse engineer any of the software comprising or in any way making up a part of SmartApp™.</li>
          <li>16.  Attempt to bypass any measures of SmartApp™ designed to prevent or restrict access to SmartApp™, or any portion of SmartApp™.</li>
          <li>17.  Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any portion of SmartApp™ to you.</li>
          <li>18.  Delete the copyright or other proprietary rights notice from any Content.</li>
          <li>19.  Copy or adapt SmartApp™’s software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.</li>
          <li>20.  Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses, or other material, including excessive use of capital letters and spamming (continuous posting of repetitive text), that interferes with any party’s uninterrupted use and enjoyment of SmartApp™ or modifies, impairs, disrupts, alters, or interferes with the use, features, functions, operation, or maintenance of SmartApp™.</li>
          ...
          <li>22.  Except as may be the result of standard search engine or Internet browser usage, use, launch, develop, or distribute any automated system, including without limitation, any spider, robot, cheat utility, scraper, or offline reader that accesses SmartApp™, or using or launching any unauthorized script or other software.</li>
          <li>23.  Disparage, tarnish, or otherwise harm, in our opinion, us and/or SmartApp™.</li>
          <li>24.  Use SmartApp™ in a manner inconsistent with any applicable laws or regulations.</li>
        </ul>
      </p>
      <p>
      As a user of SmartApp™, you agree to:
        <ul>
          ...
          <li>2.  Allow the sale of any data collected by the owners of SmartApp™.</li>
          <li>3.  Allow the occupation of any residence or property owned by the user.</li>
          <li>4.  Supply the owners of SmartApp™ with bank account numbers, credit card numbers or any information pertaining to financial assets owned by the user.</li>
      ...
      <p>
      SmartApp™ may invite you to chat, contribute to, or participate in blogs, message boards, online forums, and other functionality,
      and may provide you with the opportunity to create, submit, post, display, transmit, perform, publish, distribute,
      or broadcast content and materials to us or on SmartApp™,
      ...
      Contributions may be viewable by other users of SmartApp™ and through third-party websites.
      ...
      When you create or make available any Contributions, you thereby represent and warrant that:
        <ul>
          ...
          <li>2.  You are the creator and owner of or have the necessary licenses, rights, consents, releases, and permissions to use and to authorize us, SmartApp™, and other users of SmartApp™ to use your Contributions in any manner contemplated by SmartApp™ and these Terms of Use.</li>
          <li>3.  You have the written consent, release, and/or permission of each and every identifiable individual person in your Contributions to use the name or likeness of each and every such identifiable individual person to enable inclusion and use of your Contributions in any manner contemplated by SmartApp™ and these Terms of Use.</li>
      ...
      <p>
      Any use of SmartApp™ in violation of the foregoing violates these Terms of Use and may result in, among other things, termination or suspension of your rights to use SmartApp™.
      </p>

      <h2>CONTRIBUTION LICENSE</h2>
      <p>
      By posting your Contributions to any part of SmartApp™ or making Contributions accessible to SmartApp™ by linking your account from SmartApp™ to any of your social networking accounts,
      you automatically grant,
      and you represent and warrant that you have the right to grant,
      to us an unrestricted, unlimited, irrevocable, perpetual, non-exclusive, transferable, royalty-free, fully-paid, worldwide right,
      ...
      and to prepare derivative works of, or incorporate into other works, such Contributions, and grant and authorize sublicenses of the foregoing.
      ...
      and any of the trademarks, service marks, trade names, logos, and personal and commercial images you provide.
      ...
      We are not liable for any statements or representations in your Contributions provided by you in any area on SmartApp™.
      You are solely responsible for your Contributions to SmartApp™
      ...
      We have the right, in our sole and absolute discretion:
        <ul>
          ...
          <li>2.  to re-categorize any Contributions to place them in more appropriate locations on SmartApp™.</li>
      ...
      <p>
      We may provide you areas on SmartApp™ to leave reviews or ratings.
      </p>
      <p>
      ...
      <h2>SOCIAL MEDIA</h2>
      <p>
      As part of the functionality of SmartApp™, you may link your account with online accounts you have with third-party service providers (each such account, a “Third-Party Account”) by either:
      (1) providing your Third-Party Account login information through SmartApp™;
      ...
      without breach by you of any of the terms and conditions that govern your use of the applicable Third-Party Account,
      ...
      and store (if applicable) any content that you have provided to and stored in your Third-Party Account (the “Social Network Content”)
      so that it is available on and through SmartApp™ via your account, including without limitation any friend lists
      and (2) we may submit to and receive from your Third-Party Account additional information to the extent you are notified when you link your account with the Third-Party Account.
      Depending on the Third-Party Accounts you choose and subject to the privacy settings that you have set in such Third-Party Accounts,
      personally identifiable information that you post to your Third-Party Accounts may be available on and through your account on SmartApp™.
      Please note that if a Third-Party Account or associated service becomes unavailable or our access to such Third Party Account is terminated by the third-party service provider,
      then Social Network Content may no longer be available on and through SmartApp™.
      You will have the ability to disable the connection between your account on SmartApp™ and your Third-Party Accounts at any time.
      </p>
      <p>
      ...
      and we are not responsible for any Social Network Content. You acknowledge and agree that we may access your email address book associated with a Third-Party Account
      and your contacts list stored on your mobile device or tablet computer solely for purposes of identifying
      and informing you of those contacts who have also registered to use SmartApp™.
      You can deactivate the connection between SmartApp™ and your Third-Party Account by contacting us using the contact information below
      or through your account settings (if applicable).
      ...
      or other information regarding SmartApp™ ('Submissions') provided by you to us are non-confidential and shall become our sole property.
      ...
      <p>
      SmartApp™ may contain (or you may be sent via SmartApp™) links to other websites ('Third-Party Websites')
      ...
      and we are not responsible for any Third-Party Websites accessed through SmartApp™
      or any Third-Party Content posted on, available through, or installed from SmartApp™,
      ...
      If you decide to leave SmartApp™ and access the Third-Party Websites
      ...
      of any website to which you navigate from SmartApp™
      or relating to any applications you use or install from SmartApp™.
      ...
      <h2>ADVERTISERS</h2>
      <p>
      We allow advertisers to display their advertisements and other information in certain areas of SmartApp™,
      such as sidebar advertisements or banner advertisements.
      If you are an advertiser, you shall take full responsibility for any advertisements you place on SmartApp™
      and any services provided on SmartApp™ or products sold through those advertisements.
      Further, as an advertiser, you warrant and represent that you possess all rights
      and authority to place advertisements on SmartApp™, including, but not limited to,
      ...
      We reserve the right, but not the obligation, to:
        <ul>
          <li>1.  monitor SmartApp™ for violations of these Terms of Use. </li>
          ...
          <li>4.  in our sole discretion and without limitation, notice, or liability, to remove from SmartApp™ or otherwise disable all files and content that are excessive in size or are in any way burdensome to our systems. </li>
          <li>5.  otherwise manage SmartApp™ in a manner designed to protect our rights and property and to facilitate the proper functioning of SmartApp™. </li>
        </ul>
      </p>
      ...
      <p>
      By using SmartApp™, you agree to be bound by our Privacy Policy posted on SmartApp™,
      which is incorporated into these Terms of Use.
      Please be advised SmartApp™ is hosted in the United States.
      If you access SmartApp™ from the European Union, Asia,
      or any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States,
      then through your continued use of SmartApp™, you are transferring your data to the United States,
      ...
      and verifiable parental consent, we will delete that information from SmartApp™ as quickly as is reasonably practical.
      </p>
      ...
      <p>
      If you believe that any material available on or through SmartApp™ infringes upon any copyright you own or control,
      ...
      Thus, if you are not sure that material located on or linked to by SmartApp™ infringes your copyright, you should consider first contacting an attorney.
      </p>

      <h2>TERM AND TERMINATION</h2>
      <p>
      These Terms of Use shall remain in full force and effect while you use SmartApp™.
      </p>
      <p>
      WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE, WE RESERVE THE RIGHT TO, IN OUR SOLE DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND USE OF SmartApp™
      (INCLUDING BLOCKING CERTAIN IP ADDRESSES),
      TO ANY PERSON FOR ANY REASON OR FOR NO REASON, INCLUDING WITHOUT LIMITATION FOR BREACH OF ANY REPRESENTATION, WARRANTY, OR COVENANT CONTAINED IN THESE TERMS OF USE OR OF ANY APPLICABLE LAW OR REGULATION.
      WE MAY TERMINATE YOUR USE OR PARTICIPATION IN SmartApp™ OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.
      </p>
      <p>
      ...
      <p>
      We reserve the right to change, modify, or remove the contents of SmartApp™ at any time or for any reason at our sole discretion without notice.
      However, we have no obligation to update any information on our Site.
      We also reserve the right to modify or discontinue all or part of SmartApp™ without notice at any time.
      We will not be liable to you or any third party for any modification, price change, suspension, or discontinuance of SmartApp™.
      </p>
      <p>
      We cannot guarantee SmartApp™ will be available at all times.
      We may experience hardware, software, or other problems or need to perform maintenance related to SmartApp™,
      resulting in interruptions, delays, or errors.
      We reserve the right to change, revise, update, suspend, discontinue, or otherwise modify SmartApp™ at any time or for any reason without notice to you.
      You agree that we have no liability whatsoever for any loss, damage, or inconvenience caused by your inability to access or use SmartApp™ during any downtime or discontinuance of SmartApp™.
      Nothing in these Terms of Use will be construed to obligate us to maintain and support SmartApp™ or to supply any corrections, updates, or releases in connection therewith.
      </p>

      <h2>GOVERNING LAW</h2>
      <p>
      These Terms of Use and your use of SmartApp™ are governed by
      ...
      Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Bat County County, Utah.
      Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration,
      ...
      prosecuted in the state and federal courts located in Not Bat County County, Georgia,
      ...
      and the the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use.
      </p>
      <p>
      In no event shall any Dispute brought by either Party related in any way to SmartApp™ be commenced more than one (1) years after the cause of action arose.
      If this provision is found to be illegal or unenforceable,
      then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal
      ...
      (b) there is no right or authority for any Dispute to be arbitrated on a class-action basis
      ...
      and binding arbitration: (a) any Disputes seeking to enforce or protect, or concerning the validity of, any of the intellectual property rights of a Party;
      ...
      then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable
      ...
      <h2>CORRECTIONS</h2>
      <p>
      There may be information on SmartApp™ that contains typographical errors, inaccuracies,
      ...
      or update the information on SmartApp™ at any time, without prior notice.
      </p>

      <h2>DISCLAIMER</h2>
      <p>
      SmartApp™ IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS.
      YOU AGREE THAT YOUR USE OF SmartApp™ AND OUR SERVICES WILL BE AT YOUR SOLE RISK.
      TO THE FULLEST EXTENT PERMITTED BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH SmartApp™
      AND YOUR USE THEREOF, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE,
      AND NON-INFRINGEMENT. WE MAKE NO WARRANTIES OR REPRESENTATIONS ABOUT THE ACCURACY OR COMPLETENESS OF SmartApp™’S CONTENT
      OR THE CONTENT OF ANY WEBSITES LINKED TO SmartApp™ AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR ANY
      ...
      (4) ANY INTERRUPTION OR CESSATION OF TRANSMISSION TO OR FROM SmartApp™,
      (5) ANY BUGS, VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH SmartApp™ BY ANY THIRD PARTY, AND/OR
      (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS OR FOR ANY LOSS OR DAMAGE OF ANY KIND INCURRED AS A RESULT OF THE USE OF ANY
      CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA SmartApp™.
      WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH SmartApp™, ANY HYPERLINKED WEBSITE,
      ...
      OR AGENTS BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT, INDIRECT, CONSEQUENTIAL, EXEMPLARY, INCIDENTAL, SPECIAL,
      OR PUNITIVE DAMAGES, INCLUDING LOST PROFIT, LOST REVENUE, LOSS OF DATA,
      OR OTHER DAMAGES ARISING FROM YOUR USE OF SmartApp™,
      EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
      NOTWITHSTANDING ANYTHING TO THE CONTRARY CONTAINED HEREIN, OUR LIABILITY TO YOU FOR ANY CAUSE WHATSOEVER
      AND REGARDLESS OF THE FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE
      ...
      and all of our respective officers, agents, partners, and employees, from and against any loss, damage, liability, claim,
      ...
      <h2>USER DATA</h2>
      <p>
      We will maintain certain data that you transmit to SmartApp™ for the purpose of managing the performance of SmartApp™,
      as well as data relating to your use of SmartApp™.
      Although we perform regular routine backups of data, you are solely responsible for all data that you transmit
      or that relates to any activity you have undertaken using SmartApp™.
      ...
      <p>
      Visiting SmartApp™, sending us emails, and completing online forms constitute electronic communications.
      You consent to receive electronic communications, and you agree that all agreements, notices, disclosures,
      and other communications we provide to you electronically, via email and on SmartApp™, satisfy any legal requirement that such communication be in writing.
      </p>
      <p>
      YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS,
      AND TO ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA SmartApp™.
      </p>
      <p>
      ...
      <h2>MISCELLANEOUS</h2>
      <p>
      These Terms of Use and any policies or operating rules posted by us on SmartApp™ or
      in respect to SmartApp™ constitute the entire agreement and understanding between you and us.
      ...
      If any provision or part of a provision of these Terms of Use is determined to be unlawful, void, or unenforceable, that provision
      or part of the provision is deemed severable from these Terms of Use and does not affect the validity and enforceability of any remaining provisions.
      There is no joint venture, partnership, employment or agency relationship created between you
      and us as a result of these Terms of Use or use of SmartApp™.
      ...
      <h2>CONTACT US</h2>
      <p>
      In order to resolve a complaint regarding SmartApp™ or to receive further information regarding use of SmartApp™, please contact us at:
        <ul>
          <li>SmartApp™</li>
